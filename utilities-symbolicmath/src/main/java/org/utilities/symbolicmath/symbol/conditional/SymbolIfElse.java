...
public class SymbolIfElse<S, V> implements Symbol<S, V> {

	private Symbol<S, Boolean> condition;
	private Symbol<S, V> ifThen;
	private Symbol<S, V> elseThen;

	public SymbolIfElse(Symbol<S, Boolean> condition, Symbol<S, V> ifThen) {
		this(condition, ifThen, Symbol.empty());
	}

	public SymbolIfElse(Symbol<S, Boolean> condition, Symbol<S, V> ifThen, Symbol<S, V> elseThen) {
